...
while [ $fib -le $numfib ]
do
    rm ${subjdir}.bedpostX/commands.txt
    echo "0 ${FSLDIR}/bin/fslmaths ${subjdir}.bedpostX/merged_th${fib}samples -Tmean ${subjdir}.bedpostX/mean_th${fib}samples" >> ${subjdir}.bedpostX/commands.txt
    echo "1 ${FSLDIR}/bin/fslmaths ${subjdir}.bedpostX/merged_ph${fib}samples -Tmean ${subjdir}.bedpostX/mean_ph${fib}samples" >> ${subjdir}.bedpostX/commands.txt
    echo "2 ${FSLDIR}/bin/fslmaths ${subjdir}.bedpostX/merged_f${fib}samples -Tmean ${subjdir}.bedpostX/mean_f${fib}samples" >> ${subjdir}.bedpostX/commands.txt
    
    srun -n 3 -l --multi-prog ${subjdir}.bedpostX/commands.txt
