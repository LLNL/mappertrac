...
run_default('s1_dtiPreproc.py', args, args.input_dir + ' ' + args.output_dir)
run_default('s2a_bedpostx.py', args, args.output_dir)
run_default('s2b_freesurfer.py', args, args.output_dir)
run_default('s3_ediPreproc.py', args, args.output_dir)
run_default('s4_consensusEDI.py', args, args.output_dir)
